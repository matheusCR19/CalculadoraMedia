...
export default function Form(){
    ...
    const[nota3, setNota3]=useState(null) // estado para armazenar o peso
    ...
    return(
        ...
        {/* faz com que, ao clicar em qqr lugar da tela o teclado feche */}
            ...
            <TextInput style={styles.input} onChangeText={setNota1} value={nota1}placeholder="Ex: digite nota 1" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>
             
            <Text style={styles.formLabel}>Nota2</Text>
            <TextInput style={styles.input} onChangeText={setNota2} value={nota2}placeholder="Ex: digite nota 2" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>
             
            <Text style={styles.formLabel}>Nota3</Text>
            <TextInput style={styles.input} onChangeText={setNota3} value={nota3}placeholder="Ex: digite nota 3" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>


            <Text style={styles.formLabel}>Nota 4</Text>
            <TextInput style={styles.input} onChangeText={setNota4} value={nota4} placeholder="digite nota 4" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>
